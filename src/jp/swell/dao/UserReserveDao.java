...
public class UserReserveDao implements Serializable {
  ...
  public void setUserReserveDaoForJoin(HashMap<String, String> map, UserReserveDao dao) throws AtareSysException {
    dao.setUserReserveId(DbI.chara(map.getOrDefault("user_reserve___user_reserve_id", "")));
    dao.setUserInfoId(DbI.chara(map.getOrDefault("user_reserve___user_info_id", "")));
    dao.setReserveId(DbI.chara(map.getOrDefault("user_reserve___reserve_id", "")));
