 ...
 * @version 1.0
 */
public class RoomYoyakuDao implements Serializable {
    /** Derializable No. */
    ...
    public boolean dbSelect(String pReserveId) throws AtareSysException {
        ...
        setRoomYoyakuDaoForJoin(map, this);
        return true;
    }
     ...
     */
    public void setRoomYoyakuDao(HashMap<String, String> map, RoomYoyakuDao dao) throws AtareSysException {
        dao.setReserveId(DbI.chara(map.get("reserve_id")));
        dao.setUserInfoId(DbI.chara(map.get("user_info_id")));
        if(!"".equals(DbI.chara(map.get("user_info_id")))){
        }
     ...
     * @param dao RoomYoyakuDaoこのテーブルのインスタンス
     */
    public void setRoomYoyakuDaoForJoin(HashMap<String, String> map, RoomYoyakuDao dao) throws AtareSysException {
        dao.setReserveId(DbI.chara(map.get("reserve_id")));
        dao.setUserInfoId(DbI.chara(map.get("user_info_id")));
        dao.setRoomId(DbI.chara(map.get("room_id")));
     ...
     * @throws AtareSysException
     */
    public ArrayList<RoomYoyakuDao> getAllReserves() throws AtareSysException {
        ...
        List<HashMap<String, String>> rs = DbBase.dbSelect(sql);
        ArrayList<RoomYoyakuDao> reserves = new ArrayList<>();
        for (HashMap<String, String> map : rs) {
            RoomYoyakuDao reserve = new RoomYoyakuDao();
            // RoomYoyakuDaoのインスタンスにデータを設定
     ...
     * @throws AtareSysException
     */
    public ArrayList<RoomYoyakuDao> getCalendarReserves() throws AtareSysException {
        String sql = "SELECT reserve_id"
     ...
     * @throws AtareSysException
     */
    public RoomYoyakuDao getMostReserve() throws AtareSysException {
        // SQLクエリを最新の予約を取得する
     ...
     * @throws AtareSysException エラー
     */
    static public ArrayList<RoomYoyakuDao> dbSelectList(RoomYoyakuDao myclass, LinkedHashMap<String, String> sortKey,
            DaoPageInfo daoPageInfo) throws AtareSysException {
        ArrayList<RoomYoyakuDao> array = new ArrayList<RoomYoyakuDao>();
        ...
        for (int i = 0; i < cnt; i++) {
            map = rs.get(i);
            {
                RoomYoyakuDao dao = new RoomYoyakuDao();
     ...
     * @throws AtareSysException エラー
     */
    static public ArrayList<RoomYoyakuDao> dbSelectListYoyaku(RoomYoyakuDao myclass,
            DaoPageInfo daoPageInfo) throws AtareSysException {
        ArrayList<RoomYoyakuDao> array = new ArrayList<RoomYoyakuDao>();
