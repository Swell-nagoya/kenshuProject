...
public class RoomDao implements Serializable {
	...
	public void setRoomDao(HashMap<String, String> map, RoomDao dao) throws AtareSysException {
		...
		dao.setRoomId(DbI.chara(nullToEmpty(map.get("room___room_id"))));
		dao.setRoomName(DbI.chara(nullToEmpty(map.get("room___room_name"))));
		dao.setInsertDate(DbI.chara(nullToEmpty(map.get("room___insert_date"))));
		dao.setInsertUserId(DbI.chara(nullToEmpty(map.get("room___insert_user_id"))));
		dao.setUpdateDate(DbI.chara(nullToEmpty(map.get("room___update_date"))));
		dao.setUpdateUserId(DbI.chara(nullToEmpty(map.get("room___update_user_id"))));
	...
	public void setRoomDaoForJoin(HashMap<String, String> map, RoomDao dao) throws AtareSysException {
		...
		dao.setInsertDate(DbI.chara(nullToEmpty(getValue(map, "room___insert_date", "insert_date"))));
		dao.setInsertUserId(DbI.chara(nullToEmpty(getValue(map, "room___insert_user_id", "insert_user_id"))));
		dao.setUpdateDate(DbI.chara(nullToEmpty(getValue(map, "room___update_date", "update_date"))));
		dao.setUpdateUserId(DbI.chara(nullToEmpty(getValue(map, "room___update_user_id", "update_user_id"))));
	}
