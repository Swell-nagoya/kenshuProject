...
public class RoomDao implements Serializable {
	...
	public boolean dbSelect(String pRoomId, String roomName) throws AtareSysException {
		...
		sql += "" + " where room_id = " + DbS.chara(pRoomId) + " and room_name = " + DbS.chara(roomName);
	...
	public boolean dbInsert() throws AtareSysException {
		...
		String sql = "insert into room (" + " room_id" + ",room_name" + ",insert_date" + ",insert_user_id"
				+ ",update_date" + ",update_user_id" + " ) values ( " + DbO.chara(this.roomId) + ","
				+ DbO.chara(this.roomName) + ", NOW()"
				+ "," + (this.insertUserId.isEmpty() ? "null" : DbO.chara(this.insertUserId)) + ", NOW()"
	...
	public boolean dbUpdate(String pRoomId) throws AtareSysException {
		String sql = "update room set " + " room_name = " + DbO.chara(this.roomName) // ここもthisを使う
	...
	public boolean dbDelete(String pRoomId) throws AtareSysException {
		String sql = "UPDATE room set " + "is_deleted = true WHERE room_id = "
				+ DbS.chara(pRoomId) + "";
