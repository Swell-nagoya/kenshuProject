	...
	public void doActionProcess() throws AtareSysException {
		...
		if ("UserLogin".equals(bean.value("form_name"))) {
			...
			if ("login".equals(bean.value("action_cmd"))) {
				...
				UserLoginInfo userLoginInfo = (UserLoginInfo) getLoginInfo();//ユーザー情報の取得
				if (userLoginInfo != null && ("1".equals(userLoginInfo.getAdmin())) || "admin".equals(userLoginInfo.getAdmin())) {//ユーザー情報が空でない、またはadmin ==1 の時、管理者メニューへ行く
