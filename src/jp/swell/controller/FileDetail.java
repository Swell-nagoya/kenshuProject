...
public class FileDetail extends ControllerBase {
	...
	private void searchList() throws AtareSysException {
		...
		int maxPageNo = (recordCount + lineCount - 1) / lineCount;
		...
		bean.setValue("lineCount", String.valueOf(lineCount));
		bean.setValue("pageNo", String.valueOf(daoPageInfo.getPageNo()));
		bean.setValue("recordCount", String.valueOf(recordCount));
		bean.setValue("maxPageNo", String.valueOf(maxPageNo));
