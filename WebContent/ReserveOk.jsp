...
<jsp:useBean id="webBean" class="jp.patasys.common.http.WebBean"
	scope="request" />
<jsp:useBean id="reserveDao" class="jp.swell.dao.ReserveDao"
	scope="request" />
	...
	<form id="main_form" method="post" action="">
		...
		<div class="container">
			...
			<table>
				...
				<tr>
					<th>日付</th>
					<td><%=webBean.txt("reservation_date")%></td>
				</tr>
				<tr>
					<th>時刻</th>
					<td><%=webBean.txt("checkin_time")%> ～ <%=webBean.txt("checkout_time")%></td>
				</tr>
			</table>
			<div class="buttons">
				<a href="javascript:void(0)" onclick="go_menu('top')"
					class="btn btn-primary">一覧に戻る</a>
			</div>
		</div>
	</form>
</body>
