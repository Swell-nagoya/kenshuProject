        ...
        <div class="left">
          ...
          <tr>
            ...
            <td class=" input-text" id="userTypeContainer" style="width: 70%">
              <input type="radio" name="admin" id="admin_admin" value="1" class="ime_active <%=webBean.dispErrorCSS("admin")%>" <%= "1".equals(webBean.txt("admin")) ? "checked" : "" %> />
  <label for="admin_admin" class="<%=webBean.dispErrorCSS("admin")%>">管理者</label>
<input type="radio" name="admin" id="admin_general" value="0" class="ime_active <%=webBean.dispErrorCSS("admin")%>" <%= "0".equals(webBean.txt("admin")) ? "checked" : "" %> />
