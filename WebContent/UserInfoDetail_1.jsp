        ...
        <div class="left">
          ...
          <tr>
            ...
            <td class=" input-text" id="userTypeContainer" style="width: 70%">
              <input type="radio" name="admin" id="admin_admin" value="1" class="ime_active <%=webBean.dispErrorCSS("admin")%>" <%= webBean.txt("admin").equals("1") ? "checked" : "" %> />
                <label for="admin_admin">管理者</label>
              <input type="radio" name="admin" id="admin_general" value="0" class="ime_active <%=webBean.dispErrorCSS("admin")%>" <%= webBean.txt("admin").equals("0") ? "checked" : "" %> />
                <label for="admin_general" >一般</label> ※管理者以外は一般を選択して下さい
