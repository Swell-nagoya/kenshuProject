...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="jp.swell.dao.ContactDao"%>
...
<script type="text/javascript">
	...
	function go_submit(action_cmd) {
		document.getElementById('main_form').action = 'ContactList.do';
...
<body>
	<div class="container">
		...
		<header>
		<h1>
			<a href="javascript:void(0)" onclick="go_menu()">連絡先一覧</a>
		</h1>
		</header>
			...
			<div class="left">
				...
				<table class="list_table">
					<tr class="list_title">
						...
						<td class="list_label" style="width: 20%"><a
							href="javaScript:go_sort_request('phone_number')">電話番号</a></td>
						<td class="list_label" style="width: 20%"><a
							href="javaScript:go_sort_request('memail')">メールアドレス</a></td>
						<td class="list_label" style="width: 10%"></td>
					</tr>
					<%
					...
					<tr class="list_tr">
						...
						<td class="list_btn"><input type="button" value="編集"
							onclick="go_detail_1('go_next','update','<%=dao.getId()%>');" />
							<input type="button" value="削除"
							onclick="go_detail_1('go_next','delete','<%=dao.getId()%>');" />
							<input type="button" value="確認"
							onclick="go_detail_1('go_next','check','<%=dao.getId()%>');" />
						</td>
					</tr>
					<%
					}
