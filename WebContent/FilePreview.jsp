...
<div class="container">
  ...
  <form id="main_form" method="post" action="">
     ...
     <%
       String htmlString = webBean.txt("filePathData");
      if (htmlString != null && !htmlString.trim().isEmpty()) {
     %>
     <div class="file_preview-area">
       <%
        if (htmlString.contains("data:image")) {
       %>
       <figure>
         <img src="<%= htmlString %>" alt="画像プレビュー">
       </figure>
      <%
       } else if (htmlString.contains("data:application/pdf")) {
        %>
       	<iframe src="<%= htmlString %>" width="100%" height="400" frameborder="0" style="border:none;"></iframe>
        <%
       } else {
        %>
        <p>プレビューができません。</p>
